...
def generate_launch_description():
    ...
    rviz_config = os.path.join(nav_pkg, 'rviz', 'fcpp_cleaning_progress.rviz')  # Make sure this file exists
    ...
    navigation = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(nav_pkg, 'launch', 'sim_opennav_coverage.launch.launch.py')
        )
    )
